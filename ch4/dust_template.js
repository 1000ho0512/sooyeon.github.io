...
proxyUrl = "https://cors-anywhere-ae4t.onrender.com/"
const apiKey = "g4j1N4NNUt92WCBpeX%2Fuyw9k5tAtmwTKvWjYIqzL4mD0bYUr2QBDCarEoFNSQBMRxs48goH2TBxO6xe%2FZBDPDw%3D%3D";
...
async function parsing() {
    ...
    const forecastUrl = `${baseUrl}/getMinuDustWeekFrcstDspth?searchDate=${currentDate}&returnType=xml&serviceKey=${apiKey}&numOfRows=100&pageNo=1`;
    ...
    if (forecastData) {
        ...
        if (forecastItems.length > 0) {
            setElementContentById('D_1', forecastItems[0].querySelector('informData').textContent);
            setElementContentById('D_2', forecastItems[0].querySelector('informGrade').textContent);
            setElementContentById('D_3', forecastItems[0].querySelector('informCause').textContent);
        }
    }
}
